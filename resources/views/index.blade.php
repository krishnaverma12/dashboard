                          ...
                          <li class="header-notification">
                              ...
                              <ul class="show-notification">
                                  ...
                                  <li class="waves-effect waves-light">
                                      <div class="media">
                                          <img class="d-flex align-self-center img-radius" src="{{asset('frontend/assets/images/avatar-2.jpg')}}" alt="Generic placeholder image">
                                  ...
                                  <li class="waves-effect waves-light">
                                      <div class="media">
                                          <img class="d-flex align-self-center img-radius" src="{{asset('frontend/assets/images/avatar-4.jpg')}}" alt="Generic placeholder image">
                                          <div class="media-body">
                      ...
                      <div class="pcoded-inner-navbar main-menu">
                          <div class="">
                              <div class="main-menu-header">
                                  <img class="img-80 img-radius" src="{{asset('frontend/assets/images/avatar-4.jpg')}}" alt="User-Profile-Image">
                                                            ...
                                                            <table class="table table-hover">
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        ...
                                                                        <div class="d-inline-block align-middle">
                                                                            <img src="{{asset('frontend/assets/images/avatar-4.jpg')}}" alt="user image" class="img-radius img-40 align-top m-r-15">
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        ...
                                                                        <div class="d-inline-block align-middle">
                                                                            <img src="{{asset('frontend/assets/images/avatar-5.jpg')}}" alt="user image" class="img-radius img-40 align-top m-r-15">
                                                                            <div class="d-inline-block">
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        ...
                                                                        <div class="d-inline-block align-middle">
                                                                            <img src="{{asset('frontend/assets/images/avatar-3.jpg')}}" alt="user image" class="img-radius img-40 align-top m-r-15">
                                                                            <div class="d-inline-block">
                                                                                <h6>William Jem</h6>
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        ...
                                                                        <div class="d-inline-block align-middle">
                                                                            <img src="{{asset('frontend/assets/images/avatar-2.jpg')}}" alt="user image" class="img-radius img-40 align-top m-r-15">
                                                                            <div class="d-inline-block">
                                                                                <h6>David Jones</h6>
                                                                                <p class="text-muted m-b-0">Developer</p>
                                                                            </div>
                                            ...
                                            <div class="col-xl-4 col-md-12">
                                                <div class="card ">
                                                    ...
                                                    <div class="card-block">
                                                        ...
                                                        <div class="align-middle m-b-30">
                                                            <img src="{{asset('frontend/assets/images/avatar-1.jpg')}}" alt="user image" class="img-radius img-40 align-top m-r-15">
                                                            <div class="d-inline-block">
                                                                <h6>David Jones</h6>
                                                                <p class="text-muted m-b-0">Developer</p>
                                                            </div>
